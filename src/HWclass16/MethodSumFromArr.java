...
public class MethodSumFromArr {
   /* B
      1) Create a method that will accept an array as
         parameters and will return a sum of all elements
         from that array. Method should be visibly only within
         same package and accessible by the creating
    ...
    public static void main(String[] args) {
        ...
        int[] arr={10,25,35,45};
        MethodSumFromArr task7=new MethodSumFromArr();
